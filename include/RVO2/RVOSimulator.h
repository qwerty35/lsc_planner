...
#ifndef RVO2_RVO_SIMULATOR_H_
#define RVO2_RVO_SIMULATOR_H_
...
namespace RVO2D {
	...
	public:
		...
		size_t addAgent(const Vector2 &position, float neighborDist,
						...
						float timeHorizonObst, float radius, float maxSpeed, bool isDynamicObstacle,
						const Vector2 &velocity = Vector2());

        /**
         * \brief      remove the agent.
         * \param      agentNo        The number of agent whose removed
         * \return     The number of the agent, or RVO::RVO_ERROR when the agentNo
         *             is out of bound
         */
        size_t deleteAgent(size_t agentNo);
        ...
        /**
         * \brief      compute new velocity of agent in agentNoList
         * \param      agentNoVector     Vector of
         */
        void computeNewVelocity(const std::vector<size_t>& agentNoList);
        ...
        void setAgentIsDynamicObstacle(size_t agentNo, bool isDynamicObstacle);
